<div class="columns-1-1" id="main-content" role="main">
        ...
        <div class="portlet-layout row-fluid">
                ...
                <div class="portlet-column portlet-column-last span8" id="column-4">                		
                        $processor.processColumn("column-4", "portlet-column-content portlet-column-content-last")
                </div>
        </div>

        <div class="portlet-layout row-fluid">
                <div class="portlet-column portlet-column span12" id="column-5">
                        $processor.processColumn("column-5", "portlet-column-content portlet-column-content")
                </div>
        </div>
</div>