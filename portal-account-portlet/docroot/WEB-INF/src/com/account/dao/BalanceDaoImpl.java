...
public class BalanceDaoImpl implements BalanceDao{
	...
	public Balance getBalance(long userId) {
		...
		try{
			balance = (Balance) jdbcTemplate.queryForObject(SqlUtil.SELECT_USER_BALANCE, new Object[] {userId}, new BalanceMapper());
		}catch(EmptyResultDataAccessException exception ){
			balance = insertBalanceEmpty(userId);
		}
		return balance;
	}
	...
	private Balance insertBalanceEmpty(long userId) {
		...
		Balance balance = (Balance) jdbcTemplate.queryForObject(SqlUtil.SELECT_USER_BALANCE, new Object[] {userId}, new BalanceMapper());
		return balance;
	}
